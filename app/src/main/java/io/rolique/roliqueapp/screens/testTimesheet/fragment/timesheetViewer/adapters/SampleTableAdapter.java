package io.rolique.roliqueapp.screens.testTimesheet.fragment.timesheetViewer.adapters;
...
public class SampleTableAdapter implements TableAdapter {
    ...
    private void setText(View view, final int row, final int column) {
        final DrawableTextView drawableTextView = view.findViewById(R.id.table_item_text);
