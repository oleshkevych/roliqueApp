...
import io.rolique.roliqueapp.widget.AutoFitTextureView;
...
//        intent.putExtra(EXTRA_IS_RADIATOR_IMAGES, context instanceof RadiatorEditorActivity);
    ...
    @BindView(R.id.content_camera_preview) AutoFitTextureView mTextureView;
    ...
    public void onResume() {
        ...
        if (ContextCompat.checkSelfPermission(Camera2Activity.this, Manifest.permission.CAMERA)
