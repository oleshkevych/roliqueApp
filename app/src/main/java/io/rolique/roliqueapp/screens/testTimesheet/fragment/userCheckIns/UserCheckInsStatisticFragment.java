package io.rolique.roliqueapp.screens.testTimesheet.fragment.userCheckIns;
 ...
 */
public class UserCheckInsStatisticFragment extends BaseFragment {

    private static final int LAST_WEEK = 0;
    private static final int ALL_TIME = 1;
    private static final String ARG_USER = "USER";

    public static UserCheckInsStatisticFragment startIntent(User user) {
        Bundle args = new Bundle();
        args.putParcelable(ARG_USER, user);
        UserCheckInsStatisticFragment fragment = new UserCheckInsStatisticFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.activity_user_check_ins_statistic, container, false);
    }
